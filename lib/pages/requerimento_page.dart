...
class RequerimentoPage extends StatefulWidget {
  const RequerimentoPage({ Key? key }) : super(key: key);

  @override
  State<RequerimentoPage> createState() => _RequerimentoPageState();
}

class _RequerimentoPageState extends State<RequerimentoPage> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Text('Programação de parada', style: TextStyle(color: Colors.green, fontSize: 18)),
                  //RaisedButton(child: const Icon(Icons.date_range, color: Colors.black,), onPressed: _pickDateDialog),
                  InkWell(
                    child: Container(
                    margin: const EdgeInsets.only(top:10),
                  ...
                  InkWell(
                    ...
                    child: const Text('Gerar OS', style: TextStyle(color: Colors.white, fontSize: 20),),
                  ),
                  onTap: (){
