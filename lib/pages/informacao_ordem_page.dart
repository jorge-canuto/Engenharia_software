...
class InformacaoOrdemPage extends StatefulWidget {
  const InformacaoOrdemPage({ Key? key }) : super(key: key);

  @override
  State<InformacaoOrdemPage> createState() => _InformacaoOrdemPageState();
}

class _InformacaoOrdemPageState extends State<InformacaoOrdemPage> {
          ...
          children: [
            Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text('Responsável', style: TextStyle(color: Colors.green, fontSize: 15),),
                        Container(
                          margin: const EdgeInsets.only(left: 0, top: 5, right: 5, bottom: 5),
                          child: const Text('João da Silva', style: TextStyle(color: Colors.green, fontSize: 20),),
                        ),
                        const Divider(
                          color: Colors.grey,
                          height: 2,
                        ...
                        Expanded(
                          ...
                          child: Column(
                                  ...
                                  children: const[
                                    ...
                                    SizedBox(height: 20,),
                                    Text('Em andamento', style: TextStyle(color: Colors.yellow, fontWeight: FontWeight.bold,fontSize: 15)),
                                    Divider()
                                  ],
                                ), 
                        )
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          margin: const EdgeInsets.only(left: 0, top: 5, right: 5, bottom: 5),
                          child: const Text('Carlos', style: TextStyle(color: Colors.green, fontSize: 20),),
                        ),
                        const Divider(
                          color: Colors.grey,
                          height: 2,
